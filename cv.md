...
Experienced in release validation, regression testing, CMS quality assurance, responsive UI validation, and defect management within global enterprise environments.

Worked as a Globalization QA Analyst within the IBM ecosystem, validating large-scale web experiences using Adobe Experience Manager (AEM), Drupal, Jira, and Agile workflows.

Strong background in risk-based testing, cross-functional collaboration, and ensuring quality standards across international markets.

Currently expanding technical capabilities in automation and engineering workflows through Playwright, Selenium, Postman, and Git/GitHub.
